...
This program was written following the recommendations and algorithm given by
Peter van der Linden on his book "Expert C Programming - Deep C Secrets". It
was given as a programming challenge in chapter 3.
...
rather an implement and practice an easy algorithm.
